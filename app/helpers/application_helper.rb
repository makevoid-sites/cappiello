module ApplicationHelper
  ...
  def parse_text(text)
    ...
    TextileEnhancer.new(text, :gallery).insert do |text|
      "<div id='photos' data-set-id='#{text}' ></div><a href='http://www.flickr.com/photos/accademiacappiello/sets/#{text}/' class='flickr_button'><img src='/images/icons/flickr_icon.png' /><span>Galleria immagini</span></a>"
    end
